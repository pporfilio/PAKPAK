...
void main (void) {
    ...
    */
    ...
    vec4 p_film = vec4(regionX, regionY, regionZ, 1.0);
    vec4 p_film1 = vec4(regionX - halfPix, regionY + halfPix, regionZ, 1.0);
    vec4 p_film2 = vec4(regionX + halfPix, regionY + halfPix, regionZ, 1.0);
    vec4 p_film3 = vec4(regionX + halfPix, regionY - halfPix, regionZ, 1.0);
    vec4 p_film4 = vec4(regionX - halfPix, regionY - halfPix, regionZ, 1.0);
